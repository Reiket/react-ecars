...
const Home = React.lazy(
  () => import("../components/Pages/components/Home/Home"),
);
const Details = React.lazy(
  () => import("../components/Pages/components/Details/Details"),
);
const Favorites = React.lazy(
  () => import("../components/Pages/components/Favorites/Favorites"),
);
const About = React.lazy(
  () => import("../components/Pages/components/About/About"),
);
const FAQ = React.lazy(() => import("../components/Pages/components/Faq/Faq"));
const Find = React.lazy(
  () => import("../components/Pages/components/Find/Find"),
);
const Blog = React.lazy(
  () => import("../components/Pages/components/Blog/Blog"),
);
const Login = React.lazy(
  () =>
    import(
      "../components/Pages/components/Authorization/components/Login/Login"
    ),
);
const Register = React.lazy(
  () =>
    import(
      "../components/Pages/components/Authorization/components/Register/Register"
    ),
);
const ForgotPass = React.lazy(
  () =>
    import(
      "../components/Pages/components/Authorization/components/ForgotPass/ForgotPass"
    ),
);
const PrivacyPolicy = React.lazy(
  () => import("../components/Pages/components/PrivacyPolicy/PrivacyPolicy"),
);
const Terms = React.lazy(
  () => import("../components/Pages/components/Terms/Terms"),
);
function App() {
